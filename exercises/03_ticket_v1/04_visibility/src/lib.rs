...
mod tests {
    ...
    fn should_not_be_possible() {
        let le_ticket = Ticket::new("A title".into(), "A description".into(), "To-Do".into());
        ...
        assert_eq!(le_ticket.description, "A description");
    }
    ...
    fn encapsulation_cannot_be_violated() {
        ...
        let le_ticket = Ticket {
            title: "Le title".into(),
            description: "A description".into(),
            status: "To-Do".into(),
        };
        
        assert_eq!(le_ticket.title, "Le title");
    }
}
